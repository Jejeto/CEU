...
<head>
  ...
  <title>Menu Lateral Bloqueado</title>
  ...
  <style>
    * {
    ...
    button.ativo {
      background-color: var(--botao);
      border-radius: 30px;
      box-shadow: 0 0 0 5px var(--botao);
    }
    ...
    /* Estado da seta quando o menu está expandido (<) */
    .Menu.expanded .menu-toggle::before {
    ...
    .Menu.expanded + .conteudo-principal {
      margin-left: clamp(200px, 15%, 300px);
    }

    /* Novos estilos para a caixa preta e itens */
    ...
    .caixa-preta {
      ...
      transform: translate(-50%, -50%);
      width: 80%;
      height: calc(3 * (1.2rem + 5px) + 2 * 20px);
      /* altura de 3 botões com gap */
    ...
    .cadeado-img {
      ...
      margin: auto;
      pointer-events: none;
      /* impede clique na imagem, só na caixa-preta */
    }
...
<body>
  ...
  <div class="Menu expanded">
    <div class="conteudo">
      <div class="perfil">
        <button onclick="carregarPagina('login')">
          <img src="/Site-CEU/Imagens/FotodePerfil.webp" alt="Foto de perfil">
          <span>Perfil</span>
        </button>
      </div>
      <button onclick="carregarPagina('inicio')">Início</button>
      <div class="menu-items-container">

        <div class="caixa-preta">
          <img src="/site-CEU/Imagens/Cadeado.png" alt="Cadeado" class="cadeado-img" />
        </div>
        <div class="menu-items">
          <div class="menu-item">Meus eventos</div>
          <div class="menu-item">Certificados</div>
    ...
    <button class="rodape">
      <img src="/Site-CEU/Imagens/CEU-Vetor.png" alt="Logo CEU">
